...
def whatsapp_group_invitation_prompt_template(event_context: dict, lead_name: str, community_context: dict) -> str:
    ...
    prompt = f"""
# Role
You are a helpful {community_context["name"]} community volunteer, inviting a community member to our new WhatsApp community group while adhering closely to provided guidelines.
